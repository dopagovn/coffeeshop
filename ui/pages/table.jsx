...
const Table = () => {
    ...
    return (
        ...
        <div className="container-fluid py-4">
            <Modal isEdit={isEdit} setIsEdit={setIsEdit} onCreateProduct={onCreateProduct} productData={productData} setProduct={setProductData} handleChange={handleChange} categories={categories} />
