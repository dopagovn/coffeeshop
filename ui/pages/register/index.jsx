                        ...
                        <div className="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                            <ul className="navbar-nav navbar-nav-hover mx-auto">
                                            ...
                                            <div className="col-12 px-4 py-2">
                                                <div className="row">
                                                    <div className="col-4 position-relative">
                                                        ...
                                                        >
                                                            <span className="ps-3">Default</span>
                                                        </a>
                                                        <a
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Smart Home</span>
                                                        </a>
                                                        <a
                                                            href="../pages/dashboards/virtual-reality.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Virtual Reality</span>
                                                        </a>
                                                        <a
                                                            href="../pages/dashboards/crm.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">CRM</span>
                                                        </a>
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">New User</span>
                                                        </a>
                                                    ...
                                                    <div className="col-4 position-relative">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Teams</span>
                                                        </a>
                                                        <a
                                                            href="../pages/pages/profile/projects.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Projects</span>
                                                        </a>
                                                        <div className="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                                            <div className="d-inline-block">
                                                                <div className="icon icon-shape icon-xs border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">General</span>
                                                        </a>
                                                        <a
                                                            href="../pages/pages/projects/timeline.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Timeline</span>
                                                        </a>
                                                        <a
                                                            href="../pages/pages/projects/new-project.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">New Project</span>
                                                        </a>
                                                        <hr className="vertical dark" />
                                                    </div>
                                                    <div className="col-4">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Invoice</span>
                                                        </a>
                                                        <a
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Pricing Page</span>
                                                        </a>
                                                        <a
                                                            href="../pages/pages/rtl-page.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">RTL Page</span>
                                                        </a>
                                                        <a
                                ...
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    ...
                                    <div
                                        className="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                                        aria-labelledby="dropdownMenuAccount"
                                    >
                                        <div className="row d-none d-lg-flex">
                                            <div className="col-6">
                                                <div
                                                    className="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image"
                                                    style={{
                                                        backgroundImage:
                                                            'url("../assets/img/curved-images/curved8.jpg")',
                                                    }}
                                                >
                                                    ...
                                                    <div className="d-flex justify-content-center align-items-center text-center text-white font-weight-bold w-100 z-index-1 flex-column">
                                                        <div className="icon icon-shape rounded-circle bg-white shadow text-center">
                                                            <i
                                                                className="ni ni-diamond text-primary text-gradient text-lg"
                                                                aria-hidden="true"
                                                            />
                                                        </div>
                                            ...
                                            <div className="col-6 ps-0 d-flex justify-content-center flex-column">
                                                <ul className="list-group">
                                                    <li className="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                                        <a
                                                            className="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1"
                                                            id="dropdownSignIn"
                                                        >
                                                            <span>Sign In</span>
                                                            <img
                                        ...
                                        <div className="row d-lg-none">
                                            <div className="col-12 d-flex justify-content-center flex-column">
                                                <h6 className="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0">
                                                    Sign In
                                                </h6>
                                                <a
                                                    href="../pages/authentication/signin/basic.html"
                                                ...
                                                <h6 className="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                                    Sign Up
                                                </h6>
                                                <a
                                                    href="../pages/authentication/signup/basic.html"
                                ...
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    ...
                                    <div
                                        className="dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3"
                                    ...
                                    >
                                        ...
                                        <div className="row d-lg-none">
                                            <div className="col-md-12">
                                                <a
                                                    className="py-2 ps-3 border-radius-md"
                                                    href="../pages/applications/kanban.html"
                                                >
                                                    <div className="d-flex">
                                                        <div className="icon h-10 me-3 d-flex mt-1">
                                                        ...
                                                        <div className="w-100 d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <p className="dropdown-header text-dark p-0">Kanban</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                >
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="w-100 d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <p className="dropdown-header text-dark p-0">Wizard</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                ...
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    ...
                                    <div
                                        className="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3"
                                                ...
                                                <div className="row">
                                                    <div className="col-6 position-relative">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Order List</span>
                                                        </a>
                                                        <a
                                                            href="../pages/pages/orders/details.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Order Details</span>
                                                        </a>
                                                        <div className="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                                                            <div className="d-inline-block">
                                                                <div className="icon icon-shape icon-xs border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Referral</span>
                                                        </a>
                                                        <hr className="vertical dark" />
                                                    </div>
                                                    <div className="col-6 position-relative">
                                                        ...
                                                        <a
                                                            ...
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">New Product</span>
                                                        </a>
                                                        <a
                                                            href="../pages/ecommerce/products/edit-product.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Edit Product</span>
                                                        </a>
                                                        <a
                                                            href="../pages/ecommerce/products/product-page.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Product Page</span>
                                                        </a>
                                                        <a
                                                            href="../pages/ecommerce/products/products-list.html"
                                                            className="dropdown-item border-radius-md"
                                                        >
                                                            <span className="ps-3">Products List</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
