...
public class OrderDetailController {
  ...
  public ResponseEntity<Object> saveOrderDetail(
    @RequestBody OrderDetail orderDetail
  ) {
    try {
      OrderDetail savedOrderDetail = orderDetailService.saveOrderDetail(
        orderDetail
      );
      return ResponseHandler.generateResponse(
        HttpStatus.OK,
  ...
  public ResponseEntity<Object> getOrderDetailsByOrderId(
    ...
    try {
      List<OrderDetail> orderDetails = orderDetailService.findOrderDetailsByOrderId(
        orderId
      );
      return ResponseHandler.generateResponse(
        HttpStatus.OK,
